...
import { useTollMasterDetail } from '../hooks/use-toll-master-detail';

export const TollMasterDetailPage = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { data, isLoading } = useTollMasterDetail(id ?? '');
    ...
    <div>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Toll Master', href: ROUTES.TOLL_MASTER.LIST },
