...
import { useForceMajeureDetail } from '../hooks/use-force-majeure-claim-detail';

export const ForceMajeureDetailPage = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { data, isLoading } = useForceMajeureDetail(id ?? '');
    ...
    <div>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Force Majeure Claim', href: ROUTES.FORCE_MAJEURE.LIST },
