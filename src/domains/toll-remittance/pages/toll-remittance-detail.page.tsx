...
import { useTollRemittanceDetail } from '../hooks/use-toll-remittance-detail';

export const TollRemittanceDetailPage = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { data, isLoading } = useTollRemittanceDetail(id ?? '');
    ...
    <div>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Toll Remittance', href: ROUTES.TOLL_REMITTANCE.LIST },
