...
import { useTollPbgDetail } from '../hooks/use-toll-pbg-detail';

export const TollPbgDetailPage = () => {
  const { id } = useParams<{ id: string }>();
  const navigate = useNavigate();
  const { data, isLoading } = useTollPbgDetail(id ?? '');
    ...
    <div>
      <PageHeader
        ...
        breadcrumbs={[
          ...
          { label: 'Toll PBG', href: ROUTES.TOLL_PBG.LIST },
